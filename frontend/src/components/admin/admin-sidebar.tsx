...
import { Users, Building2, GraduationCap, TrendingUp, LogOut, Award, Calendar, ArrowRightLeft, LayoutDashboard, Calendar1, FileText } from "lucide-react"
...
export function AdminSidebar({ sidebarOpen, setSidebarOpen }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`h-screen fixed left-0 top-0 flex flex-col justify-between rounded-r-3xl shadow-2xl backdrop-blur-lg border-r border-[#8b8c89]/30 z-20 transition-transform duration-700 ease-in-out transform-gpu ${(isMobile || isTablet) ? (sidebarOpen ? 'translate-x-0' : '-translate-x-full') : 'translate-x-0'
          } ${sidebarOpen
